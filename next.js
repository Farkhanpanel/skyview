...
require('./tanzz.js')
nocache('../tanzz.js', module => console.log(color('[ UPDATE ]', 'cyan'), color(`'${module}'`, 'green'), 'File Is Update!!!'))
require('./next.js')
...
browser: ['Tanzz‚Device','Safari','1.0.0'],
auth: state,
version
})
...
console.log(color(figlet.textSync(`Tanzz ULTRA`, {
font: 'Standard',
...
require('./tanzz')(diablo, diablobotwhatsapp, chatUpdate, store)
} catch (err) {
console.log(err)}})
